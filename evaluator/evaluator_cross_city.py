...
from sklearn.metrics import mean_absolute_error, mean_squared_error, top_k_accuracy_score, root_mean_squared_error
import numpy as np
import argparse
import os
import random
...
def metrics_local(y_truths, y_preds):
    ...
    rmse = root_mean_squared_error(y_truths, y_preds)
